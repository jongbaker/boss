...
public class MailUtils_163 {
	...
	private static String userName = "jongbaker@126.com";//发 送 邮 件的1 6 3邮 箱 账 号  
    private static String password = "123456hxw";//1 6 3 邮 箱 的 授 权 码，若 没 有 则 使 用 密 码  
    //private static String userName2 = "694061256@qq.com";//接 收 邮 件 的 1 6 3 邮 箱 账 号  
    ...
    public static void sendMain(String yourMailAddress,String item,String content) throws AddressException, MessagingException, GeneralSecurityException{  
        ...
        //设置邮件服务器主机名    
        props.setProperty("mail.host", "smtp.126.com");//设置成163的发件服务器  
    ...
    public static void main(String[] args) {  
        try {  
        	sendMain("694061256@qq.com", "active", "激活");
        } catch (Exception e) {  
            e.printStackTrace();  
        }   
    }  
